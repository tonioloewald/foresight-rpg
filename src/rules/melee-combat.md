...
**And a wide skill gap buys the freedom to fight badly on purpose.** If you are far better, back *right* off and wear the −1 yourself: he now chooses between attacking off-band or spending a beat closing while you hit him again. The reason you can afford it and he can't is the One Rule's arithmetic — `SC = Score × EF`. A big Score is already at or past certainty, so an EF step costs you **quality**; a small one is on the steep part of the curve, where the same step costs you **success outright**. *Melee 25 off-band is still SC 100; Melee 10 off-band drops from 60 to 40.* **Bad conditions are the expert's friend**, and that is true of darkness, rain and broken ground as much as of distance.
