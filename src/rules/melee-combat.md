...
**Which makes Coordination decisive between equals — and nobody had to write a rule saying so.** Same sword, same shield, but you're the better mover: **strike, then give ground.** Your blow landed in your band at +1; his counter now comes from a band neither of you wants, at −1. To get his +1 back he must **come after you**, and that is where the difference tells — a contest he is worse at, and one that puts him on the floor if he loses it badly. Do it again next beat. **That is the fencer** — one of ForeSight's original gedanken cases, proven in play under the 1986 rules, and here it needs no machinery of its own.

**And a wide skill gap buys the freedom to fight badly on purpose.** If you are far better, back *right* off and wear the −1 yourself: he then chooses between attacking off-band or spending a beat closing while you hit him again.

**You can afford it because a Score past 20 is paid in the same currency as the penalty.** Melee 25 is **20+1** (see [Scores](/scores/)) — that spare **+1 EF cancels the −1 for standing off-band outright**. A 20+1 fighter can fight one band away from his weapon's preferred range and be **no worse off than an ordinary expert standing in his**. That is the fencer's licence, and it is a designed consequence of the over-20 rule rather than an accident.

**Below that, the same step is far more expensive.** `SC = Score × EF`, so a −1 comes off the top of a big Score's *surplus* — Melee 20 off-band is EF 4, SC 80, still fine — while Melee 10 off-band goes from 60 to **40**, straight off its chance of connecting at all. **Bad conditions are the expert's friend**: distance, darkness, rain, broken ground.
...
*Designer's Note — the same shelf, the opposite conclusion. The designers of D&D and I were reading much the same books; their list is printed in the original AD&D Dungeon Master's Guide, and Leiber's* Fafhrd and the Grey Mouser *is on both. From that source they built a melee system in which **nobody moves** and in which no sane person fights in anything but plate — because position is abstracted away and armour is the only defence you can buy, so the rational play is to encase yourself and stand still. But the Mouser is a **fencer**. He moves, he parries, he is not wearing plate, and he would be a poor character in a game built to honour him. I went the other way and made **manoeuvre and parry load-bearing** — which is why this page spends its space on reach, footwork, giving ground and the clinch rather than on a bigger armour table. Same bibliography; the difference is which parts you let the dice see.*
